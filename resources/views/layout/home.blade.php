        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4 bg-secondary">
                    ...
                    <a href="{{asset('Template/about.html')}}" class="nav-item nav-link">About Us</a>
                    <a href="{{asset('Template/feature.html')}}" class="nav-item nav-link">Our Features</a>
                    <a href="{{asset('Template/class.html')}}" class="nav-item nav-link">Classes</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu text-capitalize">
                            <a href="{{asset('Template/blog.html')}}" class="dropdown-item">Blog Grid</a>
                            <a href="{{asset('Template/single.html')}}" class="dropdown-item">Blog Detail</a>
                        </div>
                    </div>
